...
def test_all_case(net, image_list, num_classes, patch_size=(128, 128, 96), stride_xy=32, stride_z=24, save_result=True, test_save_path=None, preproc_fn=None):
    total_metric = 0.0
